...
public enum GaugeProperty {
    ...
    public enum GaugeElementProperty {
        ...
        ASSIST_EASY(TOTAL ,2 ,100 ,20, 60, new float[]{1.2f, 1.2f, 0.6f, -3.2f, -4.8f, -1.6f}, new float[][]{}),
        EASY(TOTAL ,2 ,100 ,20, 80, new float[]{1.2f, 1.2f, 0.6f, -3.2f, -4.8f, -1.6f}, new float[][]{}),
        NORMAL(TOTAL ,2 ,100 ,20, 80, new float[]{1.0f, 1.0f, 0.5f, -4.0f, -6.0f, -2.0f}, new float[][]{}),
        HARD(MODIFY_DAMAGE ,0 ,100 ,100, 0, new float[]{0.1f, 0.1f, 0.05f, -6.0f, -10.0f, -2.0f}, new float[][]{{30, 0.6f}}),
        EXHARD(MODIFY_DAMAGE ,0 ,100 ,100, 0, new float[]{0.1f, 0.1f, 0.05f, -12.0f, -20.0f, -2.0f}, new float[][]{}),
        HAZARD(null ,0 ,100 ,100, 0, new float[]{0.15f, 0.06f, 0, -100.0f, -100.0f, -10.0f}, new float[][]{}),
        CLASS(null ,0 ,100 ,100, 0, new float[]{0.10f, 0.10f, 0.05f, -2f, -3f, -2f}, new float[][]{{30, 0.6f}}),
        EXCLASS(null ,0 ,100 ,100, 0, new float[]{0.10f, 0.10f, 0.05f, -6.0f, -10.0f, -2.0f}, new float[][]{{30, 0.6f}}),
        EXHARDCLASS(null ,0 ,100 ,100, 0, new float[]{0.10f, 0.10f, 0.05f, -12.0f, -20.0f, -2.0f}, new float[][]{}),
